...
/**
 * Comprehensive tests for the fluent builder interface using only the Builder API (no YAML configuration).
 * Demonstrates programmatic configuration and advanced builder patterns.
 *
 * @author Mark Andrew Ray-Smith Cityline Ltd
 * @since 2025-09-01
 * @version 1.0
 */
class FluentRestMonkeyBuilderTest {

    private static final Logger logger = LoggerFactory.getLogger(FluentRestMonkeyBuilderTest.class);
    private final HttpClient client = HttpClient.newBuilder().build();

    @Nested
    class BasicBuilderUsageTest {
        ...
        @Test
        void shouldCreateServerWithBasicConfiguration() throws Exception {
            ...
            logger.debug("Health response: {}", healthBody);
        ...
        @Test
        void shouldSupportMinimalConfiguration() throws Exception {
    ...
    class BuilderChainingTest {
        ...
        void shouldSupportFluentMethodChaining() {
            ...
            // Verify configuration was built correctly by testing functionality
            assertNotNull(config);

            // Test that the configuration can be used to start a server
            ...
            try {
                ...
                assertEquals(200, response.statusCode());
                assertEquals("{\"message\":\"test successful\"}", response.body());

                // Test the resource endpoint
                var resourceResponse = client.send(
                    HttpRequest.newBuilder()
                        .uri(URI.create(baseUrl + "/api/items"))
                        .build(),
                    HttpResponse.BodyHandlers.ofString());
                assertEquals(200, resourceResponse.statusCode());
                assertTrue(resourceResponse.body().contains("Test Item"));
            } catch (IOException | InterruptedException e) {
                fail("Failed to test server: " + e.getMessage());
            } finally {
                if (server != null) {
                    server.stop();
                }
    ...
    @Nested
    class ComplexConfigurationTest {
        ...
        @Test
        void shouldSupportComplexMultiResourceConfiguration() throws Exception {
    ...
    @Nested
    class YamlEquivalentConfigurationsTest {
        ...
        @Test
        void shouldReplicateMinimalYamlConfiguration() throws Exception {
        ...
        @Test
        void shouldReplicateTextResponsesYamlConfiguration() throws Exception {
        ...
        @Test
        void shouldReplicateServerInfoYamlConfiguration() throws Exception {
    ...
    @Nested
    class HttpMethodsAndResponseTypesTest {
        ...
        @Test
        void shouldSupportAllHttpMethodsAndResponseTypes() throws Exception {
    ...
    @Nested
    class RecordReplayConfigurationTest {

        @Test
        void shouldSupportRecordReplayConfiguration() {
            ...
            // Verify record/replay configuration by testing functionality
            assertNotNull(recordConfig);
            assertNotNull(replayConfig);

            // The configurations should be valid and ready to start
            // (We can't easily test record/replay without actual HTTP traffic)
        }
    }
    ...
    class TemplatingTest {
        ...
        @Test
        void shouldSupportTemplatingLikeYamlConfiguration() throws Exception {
    ...
    class MultipleResourcesTest {
        ...
        @Test
        void shouldSupportMultipleResourcesLikeYamlConfiguration() throws Exception {
    ...
    class ChaosEngineeringTest {
        ...
        @Test
        void shouldSupportPerEndpointChaosEngineering() throws Exception {
        ...
        @Test
        void shouldSupportRandomStatusCodes() throws Exception {
    ...
    class RetryPatternsTest {
        ...
        @Test
        void shouldSupportRetryBasedSuccessPatterns() throws Exception {
    ...
    @Nested
    class CrudChaosEngineeringTest {
        ...
        @Test
        void shouldSupportChaosEngineeringOnCrudEndpoints() throws Exception {
